    ...
    <div className="h-screen w-screen bg-dark">
      <div className="relative z-0">
        ...
        <Link
          smooth={true}
          to="firstSection"
          className="scroll-link scroll-smooth uppercase absolute bottom-48 text-xl text-white rotate-90 left-[40%] md:left-[50%] font-sans tracking-widest scoll-link cursor-pointer"
        >
