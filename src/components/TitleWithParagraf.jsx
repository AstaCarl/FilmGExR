...
export default function TitleWithParagraf({introData}) {
  ...
  return (
    <article className='tw-grid transition-all duration-500 ease-in-out page-content-container v-space-lg'>
        ...
        <div className={`${isVisible ? 'w-2/3 blur-none opacity-100 translate-y-0 transition-all delay-300 duration-1000 ease-in-out' : 'blur-[2px] opacity-0 translate-y-4'}`} ref={ref}>
        <Paragraf paragrafText={introData.paragraf}/>
        </div>
        <div className={`${isVisible ? 'blur-none translate-y-0 transition-all delay-400 duration-1000 ease-in-out' : 'blur-[2px] translate-y-4'} flex gap-2 h-60 items-end`}>
