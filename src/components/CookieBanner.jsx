...
const handleButtonClick = () => {
  ...
  return (
    <div className={`${showCookieBanner ? "block" : "hidden"}`}>
        <div className='bg-black w-fit rounded-lg fixed z-[2] bottom-2 left-2 px-6 py-4 flex flex-col items-start gap-2 shadow-lg md:gap-4 md:bottom-5 md:left-5 lg:flex-row lg:items-center'>
